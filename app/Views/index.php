...
<nav class="navbar nav-padding navbar-expand-lg navbar-dark position-fixed w-100 wave-animation navbarSaya" id="myNavbar" >
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <div>
            <button class="button-primary"><a href="user/masuk.php">Masuk</a></button>
            <a class="button-secondary" href="user/daftar.php" >Daftar</a>
          </div>
        </div>
      </div>
    </nav>
      ...
      <div class="container h-100">
        <div class="row h-100">
          <div class="col-md-6 hero-tagline my-auto">
            ...
            <a class="button-lg-primary mt-5"  href="user/daftar.php">Mulai</a>
